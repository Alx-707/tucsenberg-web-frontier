    ...
    <Card className="border-green-200 bg-green-50">
      ...
      <CardContent>
        <div className="space-y-2 text-sm">
          ...
          <p>随机数: {optimizedObject.random.toFixed(4)}</p>
    ...
    if (typeof window !== 'undefined') {
      try {
        ...
        if (reactScan) {
          ...
          // 获取渲染统计
          totalRenders = reactScanInternals?.totalRenders ||
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            ...
            启用 React Scan 后，组件会显示彩色边框：🔴红色=不必要渲染，🟢绿色=优化渲染
          </CardDescription>
        </CardHeader>
        <CardContent>
          <div className="space-y-4">
            ...
            <div className="rounded-lg bg-blue-50 p-4 text-sm">
              <p className="font-semibold text-blue-900 mb-2">💡 操作指南：</p>
              <ol className="space-y-1 text-blue-800">
                <li>1. 按 <kbd className="rounded bg-blue-100 px-2 py-1 font-mono">Ctrl+Shift+X</kbd> 启用 React Scan</li>
            ...
            <div className="flex flex-wrap gap-4">
              ...
              <div className="space-y-2">
                <Button variant="destructive" onClick={triggerUnnecessaryRender} className="w-full">
        ...
        <CardContent>
          <div className="space-y-4 text-sm">
            ...
            <div>
              ...
              <p>按 <kbd className="rounded bg-gray-100 px-2 py-1">Ctrl+Shift+X</kbd> 来切换 React Scan 的启用状态。</p>
            </div>
            <div>
          ...
          <CardContent>
            <div className="space-y-6">
              <div>
                ...
                <div className="space-y-2 text-sm">
                  <p>• 按 <kbd className="rounded bg-gray-100 px-2 py-1">Ctrl+Shift+X</kbd> 启用/禁用 React Scan</p>
                  <p>• 右下角工具栏显示状态</p>
                  <p>• 与页面交互，观察组件高亮效果</p>
                </div>
              </div>
              ...
              <div>
                <h3 className="text-lg font-semibold mb-3">🎨 颜色含义</h3>
              ...
              <div>
                ...
                <div className="space-y-2 text-sm">
                  ...
                  <p>• 使用 React.memo、useMemo、useCallback 来减少不必要渲染</p>
