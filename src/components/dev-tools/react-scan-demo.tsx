...
export function ReactScanDemo() {
  ...
  if (!isReactScanEnabled) {
    const reason = process.env.NODE_ENV !== 'development'
  ...
  return (
    <Card className="p-6">
      <h3 className="mb-4 text-lg font-semibold">React Scan Performance Demo</h3>
      ...
      <div className="space-y-4">
        ...
        <Card className="bg-blue-50 p-4">
          <h4 className="mb-2 text-sm font-medium">🔍 React Scan Instructions</h4>
...
export function ReactScanStressTest() {
  ...
  return (
    <Card className="p-6">
      ...
      <div className="space-y-4">
        <div className="flex gap-2">
          <Button onClick={addItems} variant="outline">
