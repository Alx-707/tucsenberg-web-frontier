      ...
      <DropdownMenuTrigger asChild data-testid="language-dropdown-trigger">
        ...
        >
          {isPending ? (
            ...
            <Languages className='h-[1.2rem] w-[1.2rem]' data-testid="languages-icon" />
          )}
          <span className='sr-only'>{t('toggle')}</span>
        </Button>
      </DropdownMenuTrigger>
      <DropdownMenuContent align='end' data-testid="language-dropdown-content">
        <DropdownMenuItem asChild data-testid="language-dropdown-item">
          <Link
            href={pathname}
            locale='en'
          ...
          >
            ...
            {locale === 'en' && switchingTo !== 'en' && (
              <Check className='ml-auto h-4 w-4 text-green-500' data-testid="check-icon" />
            )}
          </Link>
        </DropdownMenuItem>
        <DropdownMenuItem asChild data-testid="language-dropdown-item">
