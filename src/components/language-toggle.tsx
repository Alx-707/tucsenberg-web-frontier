...
export const LanguageToggle = memo(() => {
  ...
  return (
    <div data-testid="language-switcher">
      <DropdownMenu data-testid="language-dropdown-menu" onOpenChange={setIsOpen}>
        <DropdownMenuTrigger asChild data-testid="language-dropdown-trigger">
          <Button
            variant="ghost"
            disabled={isPending}
          ...
          >
            <Globe className="text-foreground/70 h-3.5 w-3.5" data-testid="globe-icon" />
        ...
        >
          <DropdownMenuItem asChild data-testid="language-dropdown-item" className="p-0">
            <Link
              href={pathname}
              locale="en"
              className={cn(
            ...
            >
              ...
              {switchingTo === "en" && <Loader2 className="h-4 w-4 animate-spin" />}
              {locale === "en" && switchingTo !== "en" && (
                <Check className="text-foreground h-4 w-4" data-testid="check-icon" />
              )}
            </Link>
          </DropdownMenuItem>
          <DropdownMenuItem asChild data-testid="language-dropdown-item" className="p-0">
            ...
            >
              ...
              {switchingTo === "zh" && <Loader2 className="h-4 w-4 animate-spin" />}
