        ...
        <CardContent>
          <div className='grid gap-4 sm:grid-cols-2 lg:grid-cols-3'>
            <div className='space-y-2'>
              ...
              <h4 className='font-medium'>{t('responsive.mobile.title')}</h4>
            ...
            <div className='space-y-2'>
              ...
              <h4 className='font-medium'>{t('responsive.tablet.title')}</h4>
              <p className='text-muted-foreground text-sm'>
            ...
            <div className='space-y-2'>
              ...
              <h4 className='font-medium'>{t('responsive.desktop.title')}</h4>
              <p className='text-muted-foreground text-sm'>
