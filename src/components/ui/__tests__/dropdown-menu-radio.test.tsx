...
describe('DropdownMenu - Radio Components', () => {
  ...
  describe('DropdownMenuRadioGroup and RadioItem', () => {
    ...
    it('supports disabled radio items', () => {
      render(
        <DropdownMenu defaultOpen>
          ...
          <DropdownMenuContent>
            <DropdownMenuRadioGroup>
              <DropdownMenuRadioItem value='option1' data-testid='radio-enabled'>
                Enabled Option
              </DropdownMenuRadioItem>
              <DropdownMenuRadioItem value='option2' disabled data-testid='radio-disabled'>
                Disabled Option
              </DropdownMenuRadioItem>
            </DropdownMenuRadioGroup>
          </DropdownMenuContent>
    ...
    it('handles multiple radio groups', () => {
        ...
        <DropdownMenu defaultOpen>
          ...
          <DropdownMenuContent>
            <DropdownMenuRadioGroup value='size-small' data-testid='size-group'>
              <DropdownMenuRadioItem value='size-small' data-testid='size-small'>
                Small
              </DropdownMenuRadioItem>
              <DropdownMenuRadioItem value='size-large' data-testid='size-large'>
                Large
              </DropdownMenuRadioItem>
            </DropdownMenuRadioGroup>
            ...
            <DropdownMenuRadioGroup value='color-red' data-testid='color-group'>
              ...
              <DropdownMenuRadioItem value='color-blue' data-testid='color-blue'>
                Blue
              </DropdownMenuRadioItem>
            </DropdownMenuRadioGroup>
          </DropdownMenuContent>
      ...
      expect(screen.getByTestId('size-small')).toHaveAttribute('data-state', 'checked');
      expect(screen.getByTestId('size-large')).toHaveAttribute('data-state', 'unchecked');
      expect(screen.getByTestId('color-red')).toHaveAttribute('data-state', 'checked');
      expect(screen.getByTestId('color-blue')).toHaveAttribute('data-state', 'unchecked');
    });
    ...
    it('supports radio items with complex content', () => {
      render(
        <DropdownMenu defaultOpen>
          ...
          <DropdownMenuContent>
            <DropdownMenuRadioGroup>
              <DropdownMenuRadioItem value='complex' data-testid='complex-radio'>
                <div>
