...
describe('Input - Basic Rendering & Types', () => {
  ...
  describe('Input Types', () => {
    ...
    it('applies type-specific styling', () => {
      render(<Input type='search' className='search-specific' data-testid='search' />);
    ...
    it('handles invalid input types gracefully', () => {
      ...
      render(<Input type={'invalid' as React.HTMLInputTypeAttribute} data-testid='invalid-input' />);
    ...
    it('supports all HTML5 input types', () => {
      ...
      types.forEach(type => {
        const { unmount } = render(<Input type={type as React.HTMLInputTypeAttribute} data-testid={`${type}-input`} />);
    ...
    it('handles type changes dynamically', () => {
      const { rerender } = render(<Input type='text' data-testid='dynamic-input' />);
