...
// 性能指标收集器
export {
  I18nMetricsCollector, createMetricsCollector, formatMetrics, defaultMetricsCollector,
...
// 翻译预加载器
export {
  TranslationPreloader, createTranslationPreloader, PreloadStrategies,
  type Preloader as PreloaderImpl, type PreloadState,
} from './i18n-preloader';

// 主缓存管理器
export {
  I18nCacheManager, createI18nCacheManager, i18nCache,
