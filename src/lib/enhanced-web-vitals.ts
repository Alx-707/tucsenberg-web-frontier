...
// 重新导出实例
export {
    default, enhancedWebVitalsCollector, performanceAlertSystem, performanceBaselineManager, performanceMonitoringManager, performanceRegressionDetector
} from './web-vitals';

// 为了向后兼容，也导出一些常用的别名
export { performanceMonitoringManager as monitoringManager, enhancedWebVitalsCollector as webVitalsCollector } from './web-vitals';
