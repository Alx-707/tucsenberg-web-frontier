...
describe('app-constants', () => {
  describe('TIME_CONSTANTS', () => {
    it('should have correct time calculations', () => {
      expect(TIME_CONSTANTS.SECOND).toBe(TEST_TIME_CALCULATIONS.MILLISECOND_BASE);
      expect(TIME_CONSTANTS.MINUTE).toBe(
        TEST_TIME_CALCULATIONS.TIME_UNIT * TEST_TIME_CALCULATIONS.MILLISECOND_BASE
      );
      ...
      expect(TIME_CONSTANTS.DAY).toBe(
    ...
    it('should have ascending time values', () => {
      ...
      expect(TIME_CONSTANTS.HOUR).toBeLessThan(TIME_CONSTANTS.DAY);
      expect(TIME_CONSTANTS.DAY).toBeLessThan(TIME_CONSTANTS.TWENTY_FIVE_HOURS);
    });
  ...
  describe('DELAY_CONSTANTS', () => {
    it('should have reasonable delay values', () => {
      ...
      expect(DELAY_CONSTANTS.STANDARD_TIMEOUT).toBe(TEST_TIME_CALCULATIONS.MILLISECOND_BASE);
      ...
      expect(DELAY_CONSTANTS.CLEANUP_DELAY).toBe(TEST_DELAY_VALUES.CLEANUP_DELAY);
    });
